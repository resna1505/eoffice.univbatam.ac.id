...
class Surat_masuk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['contents'] = 'admin/v_surat_masuk';
        #print_r($this->data);
    ...
    public function tampil($id = null)
    {
        ...
        $this->data['menu'] = 'admin/v_menu';
        $this->data['contents'] = 'admin/v_surat_masuk_tampil';
    ...
    public function rekap()
    {
        ...
        $this->data['menu'] = 'admin/v_menu';
        $this->data['contents'] = 'admin/v_surat_masuk_rekap';
        $this->load->view('admin/v_home', $this->data);
    }
    ...
    {
        $this->data['rekap_surat'] =  $this->Surat_masuk_model->getAll();
        $this->load->view('admin/v_surat_masuk_cetak', $this->data);
    }
