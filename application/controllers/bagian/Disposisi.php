...
class Disposisi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['contents'] = 'bagian/v_disposisi';
    ...
    public function rekap()
    {
        ...
        $this->data['menu'] = 'bagian/v_menu';
        $this->data['contents'] = 'bagian/v_disposisi_rekap';
        $this->load->view('bagian/v_home', $this->data);
    }
    ...
    public function cetak($id)
    {
        ...
        $this->load->view('bagian/v_disposisi_cetak', $this->data);
    }
    ...
    public function tampil($id = null)
    {
        ...
        $this->load->model('Pegawai_login_model');
        #$this->Log_surat_masuk_model->add_log($this->Pegawai_login_model->current_user()->USERNAME, $id, "Menampilkan Disposisi surat masuk");
        $this->data['user'] = $this->Pegawai_login_model->current_user();
        ...
        $this->data['menu'] = 'bagian/v_menu';
        $this->data['contents'] = 'bagian/v_disposisi_surat_masuk_tampil';
    ...
    public function update_status()
    {
        ...
        redirect(site_url('bagian/disposisi'));
    }
    ...
    public function download($file)
    {
        ...
        $this->Log_surat_masuk_model->add_log($this->Pegawai_login_model->current_user()->USERNAME, $surat->ID_SURAT_MASUK, "Download Disposisi surat masuk");
