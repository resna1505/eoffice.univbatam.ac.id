...
class Surat_keluar extends CI_Controller
{
    ...
    public function index()
    {
        ...
        exit();
        $this->data['kategori_srt_keluar'] = $this->Jenis_srt_keluar_model->getAll();
        $this->data['surat_keluar'] = $this->Surat_keluar_model->getAllApprovalPimpinan();
    ...
    public function draft()
    {
        ...
        $this->data['surat_keluar'] = $this->Surat_keluar_model->getAllDraftByPimpinan($this->data['user']->ID_PEGAWAI);
        // } else {
        ...
        $this->data['menu'] = 'pimpinan/v_menu';
        $this->data['contents'] = 'pimpinan/v_draf_surat_keluar';
        $this->load->view('pimpinan/v_home', $this->data);
    }
    ...
    public function draft_tampil($id_surat)
    {
        ...
        $this->data['menu'] = 'pimpinan/v_menu';
        if ($this->data['user']->ID_PEGAWAI != $this->data['surat']->ID_APPROVAL) {
            $this->data['contents'] = 'pimpinan/v_draf_surat_keluar_tampil_restricted';
        } else {
            $this->data['contents'] = 'pimpinan/v_draf_surat_keluar_tampil';
        }
        $this->load->view('pimpinan/v_home', $this->data);
    }
