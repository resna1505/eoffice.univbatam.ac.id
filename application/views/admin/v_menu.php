    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="<?= site_url('admin/kategori_srt_masuk') ?>">
                        <i class="bi bi-circle"></i><span>Kategori Surat Masuk</span>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('admin/kategori_srt_keluar') ?>">
                        <i class="bi bi-circle"></i><span>Kategori Surat Keluar</span>
                    </a>
                </li>
                <li>
