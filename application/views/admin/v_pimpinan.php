                ...
                <form method="POST" action="<?= site_url('admin/pimpinan/edit') ?>">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <label for="inputText" class="col-sm-2 col-form-label">Nama Pegawai</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="<?= $edit->NM_PEGAWAI ?>" readonly>
                                <input type="text" class="form-control" name="id_pegawai" value="<?= $edit->ID_PEGAWAI ?>" readonly>
