                ...
                <div class="modal fade" id="tambahModal" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form method="POST" action="<?= site_url('admin/surat_keluar/add') ?>" id="formTambah">
...
<?php foreach ($surat_keluar as $surat) { ?>
    ...
    <div class="modal fade" id="editModal<?= $surat->ID_SURAT_KELUAR ?>" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="<?= site_url('admin/surat_keluar/edit') ?>" enctype="multipart/form-data" id="formEdit<?= $surat->ID_SURAT_KELUAR ?>">
                    <div class="modal-header">
