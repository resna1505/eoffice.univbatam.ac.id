                                    ...
                                    <tbody>
                                        ...
                                        foreach ($surat_keluar as $row) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row->STATUS == '2') : ?>
                                                        <button class="btn btn-outline-danger btn-sm">Release</button>
                                                    <?php endif; ?>
                                                </td>

                                                <td>

                                                    <a href="<?= site_url($this->uri->segment(1) . '/surat_keluar/tampilrelease/' . $row->ID_SURAT_KELUAR) ?>">
                                                        <button type="button" class="btn btn-outline-success btn-sm" title="View Data">
                                                            <i class="bi bi-search"></i> Tampil
                                                        </button>
                                                    </a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="<?= site_url('admin/surat_keluar/release') ?>" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Release Surat Keluar </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="tgl_diterima" class="form-control" value="<?= date('Y-m-d') ?>" id="datePicker" placeholder="YYYY-MM-DD" autocomplete="off" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
								...
								<input type="hidden" name="id_tujuan" class="form-control" value="<?= $surat->ID_TUJUAN ?>" required>
							</div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputDate" class="col-sm-2 col-form-label">Tgl Surat</label>
                            <div class="col-sm-10">
                                <input name="tgl_surat" class="form-control" value="<?= $surat->TGL_SURAT ?>" class="form-control" id="datePicker" placeholder="YYYY-MM-DD" autocomplete="off" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="inputNumber" class="col-sm-2 col-form-label">File Surat Keluar (PDF) </label>
                            <div class="col-sm-10">
                                <input class="form-control" type="file" name="file_surat" id="file_surat" required>
                                <small class="text-danger">Wajib di lampirkan surat keluar, max size 1 MB</small>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="bi bi-arrow-left-square"></i> Close</button>
                        <button type="submit" class="btn btn-danger"><i class="bi bi-save"></i> Release</button>
                    </div>
                </form>
            </div>
        </div>
