                ...
                <div class="modal fade" id="tambahModal" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form method="POST" action="<?= site_url('bagian/surat_keluar/draft_add') ?>" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!--<div class="row mb-3">
                                            <label for="inputText" class="col-sm-2 col-form-label">Nama Tujuan</label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="id_approval">
                                                <?php
                                                foreach ($approval as $peg) {
                                                    $id_pegawai = $peg->ID_PEGAWAI;
                                                    #if ($id_pegawai == $row->ID_APPROVAL) {
                                                    #    $txt1 = "selected";
                                                    #} else {
                                                    #    $txt1 = "";
                                                    #}
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputNumber" class="col-sm-2 col-form-label">File Draft Surat (PDF) </label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="file" name="file_surat" id="file_surat" required>
                                            <small class="text-danger">Maksimal size 1 Mb</small>
                                        </div>
                                    </div>
...
<?php foreach ($draft_surat_keluar as $surat) { ?>
    <!-- End Edit Draf Surat Masuk Modal-->
    <div class="modal fade" id="editModal<?= $surat->ID_SURAT_KELUAR ?>" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="<?= site_url('bagian/surat_keluar/draft_edit') ?>" enctype="multipart/form-data">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control" name="id_tujuan">
                                    <?php
                                    #echo '<option value="0">- Semua Bagian -</option>';
                                    foreach ($bagian as $data_r) {
                                        $id_bagian = $data_r->ID_BAGIAN;
                                        if ($id_bagian == $surat->ID_TUJUAN) {
                                            $txt1 = "selected";
                                        } else {
                                            $txt1 = "";
                                        }

                                        echo '<option value=' . $id_bagian . ' ' . $txt1 . '>' . $data_r->NM_BAGIAN . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control" name="id_approval">
                                    ...
                                    foreach ($approval as $peg) {
                                        $id_pegawai = $peg->ID_PEGAWAI;
                                        if ($id_pegawai == $surat->ID_APPROVAL) {
                                            $txt1 = "selected";
                                        } else {
                                            $txt1 = "";
                                        }
