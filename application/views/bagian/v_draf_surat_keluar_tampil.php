                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Status Surat : <?php $status = $surat->STATUS ?>
                            ...
                            <?php if ($surat->STATUS == '1') : ?>
                                <span class="badge bg-success">Sudah di tandatangan</span>
                            <?php endif; ?>
                        </h5>
            ...
            <form method="POST" action="<?= site_url($this->uri->segment(1) . '/surat_keluar/aproved') ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nomor_surat" class="form-control" value="<?= $this->referensi->nmJenisSuratKeluar($surat->ID_KATEGORI_SRT_KELUAR) ?>" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <?php if ($surat->STATUS == '0') : ?>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="tgl_ttd" class="form-control" value="<?= date('Y-m-d') ?>" id="datePicker" placeholder="YYYY-MM-DD" autocomplete="off" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nm_pimpinan" class="form-control" value="<?= $this->referensi->nmPegawai($surat->ID_APPROVAL) ?>" readonly>
