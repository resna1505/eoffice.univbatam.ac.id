...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="#" class="logo d-flex align-items-center">
                <img src="<?= base_url('assets') ?>/assets/img/logo-uniba.png" alt="">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Develop By <strong><span>IT Universitas Batam</span></strong>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Fungsi untuk menampilkan atau menyembunyikan field disposisi
            function toggleDisposisiFields() {
                var selectedStatus = $('#status-surat-select').val();
                if (selectedStatus === '3') { // Jika 'Disposisi' dipilih (value="3")
                    $('#disposisi-fields').slideDown(); // Tampilkan dengan efek slide
                    // Atau jika hanya ingin langsung tampil:
                    // $('#disposisi-fields').show(); 
                } else {
                    $('#disposisi-fields').slideUp(); // Sembunyikan dengan efek slide
                    // Atau jika hanya ingin langsung sembunyi:
                    // $('#disposisi-fields').hide();
                }
            }

            // Panggil fungsi saat halaman pertama kali dimuat
            // Ini penting jika STATUS_SURAT sudah '3' saat halaman dimuat
            toggleDisposisiFields();

            // Panggil fungsi setiap kali pilihan di dropdown berubah
            $('#status-surat-select').on('change', function() {
                toggleDisposisiFields();
            });
        });
    </script>
