            ...
            <form method="POST" action="<?= site_url($this->uri->segment(1) . '/disposisi/add') ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="tanggal_disposisi" class="form-control" value="<?= date('Y-m-d') ?>"  id="datePicker" placeholder="YYYY-MM-DD" autocomplete="off" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputDate" class="col-sm-2 col-form-label">Tgl Selesai</label>
                        <div class="col-sm-10">
                            <input name="tanggal_selesai" class="form-control" value="<?= date('Y-m-d') ?>"  id="datePicker" placeholder="YYYY-MM-DD"  autocomplete="off" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Pemberi Disposisi </label>
                        <div class="col-sm-10">
							<input type="text" name="nm_pemberi" class="form-control" value="<?= $this->referensi->nmPegawai($surat->ID_TUJUAN)?>" readonly>
							<input type="hidden" name="id_pemberi" class="form-control" value="<?= $surat->ID_TUJUAN ?>" readonly>
