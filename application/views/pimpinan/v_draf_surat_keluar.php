                                ...
                                <form method="POST" action="<?= site_url('admin/surat_keluar/draft_add') ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="tgl_surat" class="form-control" id="datePicker" placeholder="YYYY-MM-DD" required readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                ...
                <form method="POST" action="<?= site_url('admin/surat_keluar/draft_edit') ?>" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <label for="inputDate" class="col-sm-2 col-form-label">Tgl Surat</label>
                            <div class="col-sm-10">
                                <input name="tgl_surat" class="form-control" value="<?= $surat->TGL_SURAT ?>" id="datePicker" placeholder="YYYY-MM-DD" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputText" class="col-sm-2 col-form-label">Approval</label>
