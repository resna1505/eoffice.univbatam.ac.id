                ...
                <form method="POST" action="<?= site_url('admin/surat_keluar/release') ?>" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="tgl_diterima" class="form-control" value="<?= date('Y-m-d') ?>"  id="datePicker" placeholder="YYYY-MM-DD" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="inputNumber" class="col-sm-2 col-form-label">File Surat Keluar </label>
                            <div class="col-sm-10">
