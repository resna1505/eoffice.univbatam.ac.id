                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
							...
							<input type="text" name="perihal" class="form-control" value="<?= $surat->ID_TUJUAN ?>">
						</div>
                    </div>
                    ...
                    <?php if ($surat->STATUS == '0') : ?>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="tgl_ttd" class="form-control" value="<?= date('Y-m-d') ?>"  id="datePicker" placeholder="YYYY-MM-DD" required>
                            </div>
                        </div>
