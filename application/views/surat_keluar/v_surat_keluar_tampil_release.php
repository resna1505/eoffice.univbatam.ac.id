...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?= site_url($this->uri->segment(1) . '/surat_keluar/download/' . $surat->FILE_RELEASE) ?>"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-arrow-down-square"></i> Download File </button></a>
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Status Surat : <?php $status = $surat->STATUS ?>
                            ...
                            <?php if ($surat->STATUS == '2') : ?>
                                <span class="badge bg-success">Sudah Release</span>
                            <?php endif; ?>
                        </h5>

                        <iframe src="<?= base_url() ?>upload/surat_keluar/<?= $surat->FILE_RELEASE ?>" width="100%" height="400"></iframe>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Data Log Surat Keluar</h5>
