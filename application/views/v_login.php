						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="d-flex justify-content-center py-4">
								<a href="index.html" class="logo d-flex align-items-center w-auto">
									<img src="<?= base_url('assets') ?>/assets/img/logo-uniba.png" alt="Logo Universitas Batam">
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="pt-4 pb-2">
										...
										<p class="text-center small">e-Office</p>
									</div>
							...
							<div class="credits">
								Developed by <a href="#">IT Universitas Batam</a>
							</div>
